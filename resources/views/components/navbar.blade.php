        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li class="dropdown-item"><a class="nav-link" href="{{ route('listar.noticias') }}">Notícias</a></li>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('fake-news-detection.list') }}">Detecção de fake news</a>
                    </div>
                </div>
                @endrole
                @guest
