...
//    Route::get('/listar/visualizar/{id}', [RegisterFormController::class, ''])->name('visualizar.dados');
    ...
    Route::get('/fake-news-detection/fnd/{id}/edit', [FakeNewsDetectionController::class, 'edit'])->name('fake-news-detection.edit');
    Route::put('/fake-news-detection/fnd/{id}', [FakeNewsDetectionController::class, 'update'])->name('fake-news-detection.update');
    Route::delete('/fake-news-detection/fnd/{id}', [FakeNewsDetectionController::class, 'destroy'])->name('fake-news-detection.destroy');
});
