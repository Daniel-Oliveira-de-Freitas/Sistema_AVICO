...
trait AssocieComponentStepRulesTrait
{
    private $validationRules = [
        ...
        3 => [
            ...
            'data.password' => 'required|min:8|required_with:data.confirmPassword|same:data.confirmPassword',
            'data.confirmPassword' => 'required|min:8',
