                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="tel" name="celular" id="celular"
                                data-parsley-minlength="10" maxlength="18" required>
                            <br>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <br>
                            <span id="message_errorTelefoneResidencial" style="color: red; visibility:hidden;">Insira um
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="text" name="cep" id="cep"
                                data-parsley-minlength-message="Insira um CEP válido." data-parsley-minlength="8"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <input class="condicao form-check-input" type="checkbox" name="condicoes[]"
                                    id="familiar" value="Familiar de vítima da COVID-19" onchange="condicaoChanged()">
                            </div>
                            <div class="form-check">
                        ...
                        <div id="grauParentesco" class="mb-3">
                            ...
                            <select onchange="outrosInputShow()" class="parentesco" name="parentesco" id="parentesco"
                                required>
