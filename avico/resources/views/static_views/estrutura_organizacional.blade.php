    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="{{ asset('images/assets/img/team/RosangelaOSilva.png')}}" alt="..." />
                    <h4>Rosângela O. Silva</h4>
                    <p class="text-muted">Vice-presidente de saúde da Avico Brasil</p>
                    <p class="text-muted">Socióloga(FESPSP), Assistente Social(Universidade Braz Cubas) - CRESS 61.689, Servidora Pública. Assiciada da Avico Brasil.</p>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="{{ asset('images/assets/img/team/PamelaCopettiGhisleni.png')}}" alt="..." />
                    <h4>Pâmela Copetti Ghisleni</h4>
                    <p class="text-muted">Vice-presidente júridica da Avico Brasil</p>
                    <p class="text-muted">Professora do Curso de Graduação em Direito da Faculdade CNEC Santo Ângelo, Advogada(OAB/RS 100.497).</p>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="{{ asset('images/assets/img/team/VeraLuciadeMeloAragao.png')}}" alt="..." />
                    <h4>Vera Lúcia de Melo Aragão</h4>
                    <p class="text-muted">Vice-presidente de Assistência Social e Previdência da Avico Brasil</p>
                    <p class="text-muted">Professora, Pedagoga e Historiadora formada pela UERJ, com Pós graduação em Gestão Escolar, 
            ...
            <div class="col-lg-6">
                ...
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="{{ asset('images/assets/img/team/AcirJosePereiradeBastos.png')}}" alt="..." />
                    <h4>Acir José Pereira de Bastos</h4>
                    <p class="text-muted">Vice-presidente Administrativo Financeiro da Avico Brasil</p>
                    <p class="text-muted">Empresário, Formado em Administração pela UFPR, Pós-graduado em Auditoria e MBA em Gestão Empresarioal pela FAE Business School Curitiba-PR.</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <h4>Gilmar Loeblein Pauli, Luiz Fernando Valadares e Núria Debertolis da Motta</h4>
                <p class="large text-muted">Titulares</p>
                <h4>Carolina Tavares Oliveira Borges, Ivana Bernardes Lima e Maria Beatriz Mariante Brutto</h4>
