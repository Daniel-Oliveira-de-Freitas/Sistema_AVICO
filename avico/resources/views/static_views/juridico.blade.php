...
<section class="page-section">
    ...
    <main class="container container-text">
            ...
            <p>
                <strong>Representação Criminal contra o Presidente do Brasil junto a Procuradoria-Geral da República (MPF)</strong>
            </p>

            <p>
                A AVICO protocolou em junho de 2021 uma representação criminal contra o Presidente Jair Bolsonaro junto à Procuradoria-Geral da República (PGR) em razão de sua temerária condução durante a pandemia. A representação criminal, não é um processo judicial, e sim uma denúncia à PGR que tem prerrogativa de defender a sociedade e titularidade na área penal. Caso seja julgada procedente pelo judiciário, irá beneficiar toda a população brasileira com o afastamento de Bolsonaro do cargo por pelo menos 180 dias. A nossa intenção é que ele seja investigado e responsabilizado por suas ações de boicote as políticas públicas de enfrentamento a pandemia, impactando diretamente para disseminação em massa do vírus e diversas fake news. Você pode acessar o inteiro teor da peça <a href="https://avicobrasil.com.br/wp-content/uploads/2021/06/Representacao-Criminal-AVICO-Versao-PROTOCOLO-assinado.pdf">neste link.</a>
            </p>

            <p>
                A representação apresentada pela AVICO é a primeira no Brasil protagonizada por vítimas e familiares de vítimas da covid-19 e está inspirada em <a href="https://www.bbc.com/portuguese/internacional-53397353">iniciativa semelhante ocorrida na Itália</a> – Bérgamo/Lombardia, em que uma associação de familiares de vítimas e sobreviventes da covid-19 cobram o governo local sobre omissões e ações equivocadas no enfrentamento à pandemia.
            </p>
            ...
            <p>
                *Você pode acessar os endereços e telefones das Promotorias <a href="https://www.mprs.mp.br/promotorias/">neste link</a> e das Delegacias de Polícia de Pronto Atendimento <a href="https://www.pc.rs.gov.br/telefones-dppas">neste link</a>
            </p>

            <p>
                <strong>Ação Civil Pública contra a União em favor das vítimas fatais e sobreviventes com sequelas graves e persistentes da covid-19</strong>
            </p>
