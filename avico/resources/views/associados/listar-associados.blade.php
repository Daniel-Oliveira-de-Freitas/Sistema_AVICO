            ...
            <tbody>
                @foreach ($inscricoes as $inscricao)
                    <tr>
                        ...
                        <td>
                            @if (isset($inscricao->person->tipo_pagamento->name))
                        ...
                        <td>
                            <form method="GET" action="{{ route('baixar_dados', $inscricao->id) }}"><button
                                    type="submit" class="btn btn-info btn-md"><i class="fa-solid fa-download"></i> Download
                                    Arquivos</button></form>
                        </td>
                        <td>
                            <div class="btn-group">
                                ...
                                <button type="button" role="button" href="#" data-toggle="modal"
                                    data-target="#ModalAprovar{{ $inscricao->id }}" class="btn btn-success btn-sm"><i
                                        class="fa-solid fa-check"></i> Deferir</button>
                                <button type="button" role="button" href="#" data-toggle="modal"
                                    data-target="#ModalReprovar{{ $inscricao->id }}" class="btn btn-danger btn-sm"><i
                                        class="fa-solid fa-trash"></i> Indeferir</button>
                            </div>
                        </td>
                    </tr>
